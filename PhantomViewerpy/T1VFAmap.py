...
def init (FA=None, data=None, TR=10000, TE=0.0):    
...
def objfunction(params, FA, data):  #note flip angles FA must be in radians
    """ T1-VFA model ; FA flip angle array in radians, TR recovery time"""
    B = params['B'].value
